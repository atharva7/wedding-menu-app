...
export const CATEGORIES = [
  {
    ...
    max: t(3, 5, 8),
    items: [
      { id: "aamPannaMojito", name: "Aam Panna Mojito (Virgin/Spiked)" },
      { id: "kokumCooler", name: "Kokum Cooler with Mint" },
      { id: "jaljeeraSpritz", name: "Jaljeera Spritz with Fresh Lime" },
      { id: "lycheeBellini", name: "Lychee Rose Bellini" },
      { id: "chaiMartini", name: "Masala Chai Espresso Martini" },
      { id: "blueLemonade", name: "Blue Pea Flower Lemonade" },
      { id: "coconutWater", name: "Fresh Coconut Water Station" },
      { id: "juiceBar", name: "Cold-Pressed Juice Bar" },
    ],
  },
  {
    id: "liveCounters",
    ...
    max: t(2, 4, 6),
    items: [
      { id: "chaatCorner", name: "Chaat Corner - Build Your Own" },
      { id: "bombayStreetTruck", name: "Bombay Street Food Truck" },
      { id: "delhiChaatHub", name: "Delhi Chaat Hub" },
      { id: "indoMexican", name: "Indo-Mexican Station" },
      { id: "asianFusion", name: "Asian-Indian Fusion" },
      { id: "mediterranean", name: "Mediterranean Meets India" },
    ],
  },
  {
  ...
  },
  {
    ...
    max: t(4, 8, 12),
    items: [
      { id: "gulabJamunCheesecakeShots", name: "Gulab Jamun Cheesecake Shots" },
      { id: "rasmalaiMartini", name: "Rasmalai in Martini Glasses" },
      { id: "phirniJars", name: "Phirni Jars with Edible Flowers" },
      { id: "shrikhandCups", name: "Shrikhand Cups with Saffron" },
      { id: "rabriShots", name: "Rabri Shots with Nuts" },
      { id: "gajarHalwaTiramisu", name: "Gajar Halwa Tiramisu Cups" },
    ],
  },
  {
    ...
    max: t(1, 2, 3),
    items: [
      { id: "kulfiBar", name: "Kulfi Bar (Paan, Mango, Kesar-Pista, Rose, Chocolate)" },
      { id: "iceCreamRoll", name: "Ice Cream Roll Station (Nitrogen)" },
      { id: "waffleCrepe", name: "Waffle & Crepe Station" },
    ],
  },
  {
    id: "fusionSweets",
    ...
    max: t(3, 5, 7),
    items: [
      { id: "gulabJamunDonuts", name: "Gulab Jamun Donuts" },
      { id: "jalebiCheesecake", name: "Jalebi Cheesecake" },
      { id: "rasmalaiCakePops", name: "Rasmalai Cake Pops" },
      { id: "chocolateSamosas", name: "Chocolate Samosas" },
      { id: "motichoorBrownies", name: "Motichoor Ladoo Brownies" },
      { id: "paanIceCreamSandwiches", name: "Paan Ice Cream Sandwiches" },
      { id: "churrosRabri", name: "Churros with Rabri Dip" },
    ],
  },
  {
    id: "candyMithai",
    ...
    availableFrom: 2,
    items: [
      { id: "mithaiTower", name: "Assorted Mithai Tower" },
      { id: "chocolateFountain", name: "Chocolate Fountain with Fruits" },
      { id: "cottonCandy", name: "Cotton Candy Station" },
      { id: "popcornBar", name: "Popcorn Bar (Caramel/Cheese/Peri-Peri)" },
    ],
  },
  {
    id: "midnightSnacks",
    ...
    max: t(2, 4, 4),
    items: [
      { id: "maggiBar", name: "Maggi / Instant Noodles Bar" },
      { id: "sandwichGriller", name: "Sandwich Griller (Bombay Sandwich, Cheese Chili Toast)" },
      { id: "pakoraCounter", name: "Pakora Counter (Fresh Fried)" },
      { id: "friesStation", name: "French Fries Station (Peri-Peri/Masala/Cheese)" },
    ],
  },
];
